...
function Combobox<Value, Multiple extends boolean | undefined = false>({
  ...
  const itemToStringLabel = itemToStringLabelProp ?? defaultItemToStringLabel as (item: Value) => string
  const itemToStringValue = itemToStringValueProp ?? defaultItemToStringValue as (item: Value) => string
...
function ComboboxContent({
  ...
  const resolvedPortalContainer = portalContainer ?? dialogPortalContainer ?? undefined
